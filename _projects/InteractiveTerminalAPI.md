...
Once the mod was ready for release, "Lategame Upgrades" was the first ever mod to utilize it fully, making the selection of upgrades (and several other features later developed such as refunds and purchase with alternate currencies) much easier to interact with. Several other mods also started using this mod to facilitate their interactions such as shop purchases ([Purchase of windows for the ship](https://thunderstore.io/c/lethal-company/p/TestAccount666/ShipWindows/)) and item management ([Storage of items in bulk](https://thunderstore.io/c/lethal-company/p/LethalCompanyModding/ShipInventoryUpdated/)).

If you are interested in seeing how it has evolved since its first Thunderstore release, click [here](https://thunderstore.io/c/lethal-company/p/WhiteSpike/Interactive_Terminal_API/)